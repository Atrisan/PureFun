...
import de.simpleproglang.purefun.coco.MapOrListExistsConcatCoCo;
...
public class MapOrListExistsConcatCocoTest extends AbstractTest {
    ...
    public void test(String modelName, String Path) {
        ...
        Log.info("module loaded", "MapOrListExistsConcatCoco");

        PureFunCoCoChecker checker = new PureFunCoCoChecker();
        MapOrListExistsConcatCoCo variableCoco = new MapOrListExistsConcatCoCo();
