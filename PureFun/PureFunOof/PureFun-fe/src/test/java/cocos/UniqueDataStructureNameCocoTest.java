...
import de.simpleproglang.purefun.coco.UniqueDataStructureNameCoCo;
...
public class UniqueDataStructureNameCocoTest extends AbstractTest {
    ...
    public void test(String modelName, String Path) {
        ...
        Log.info("module loaded", "UniqueDataStructureNameCoco");

        PureFunCoCoChecker checker = new PureFunCoCoChecker();
        UniqueDataStructureNameCoCo variableCoco = new UniqueDataStructureNameCoCo();
