...
import de.simpleproglang.purefun.coco.MapExistsKeyListCoCo;
...
public class MapExistsKeyListCocoTest extends AbstractTest {
    ...
    public void test(String modelName, String Path) {
        ...
        Log.info("module loaded", "MapExistsKeyListCoco");

        PureFunCoCoChecker checker = new PureFunCoCoChecker();
        MapExistsKeyListCoCo variableCoco = new MapExistsKeyListCoCo();
