...
import de.simpleproglang.purefun.coco.DataStructureSubVariableExistsCoCo;
...
public class DataStructureSubVariableExistsCocoTest extends AbstractTest {
    ...
    @ParameterizedTest
    @CsvSource(
        "DataStructureSubVariableExists"
    )
    ...
    public void test(String modelName, String Path) {
        ...
        Log.info("module loaded", "DataStructureSubVariableExistsCoco");

        PureFunCoCoChecker checker = new PureFunCoCoChecker();
        DataStructureSubVariableExistsCoCo variableCoco = new DataStructureSubVariableExistsCoCo();
