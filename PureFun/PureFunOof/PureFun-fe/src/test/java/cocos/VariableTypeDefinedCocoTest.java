...
import de.simpleproglang.purefun.coco.VariableTypeDefinedCoCo;
...
public class VariableTypeDefinedCocoTest extends AbstractTest {
    ...
    public void test(String modelName, String Path) {
        ...
        Log.info("module loaded", "VariableTypeDefinedCoco");

        PureFunCoCoChecker checker = new PureFunCoCoChecker();
        VariableTypeDefinedCoCo variableCoco = new VariableTypeDefinedCoCo();
