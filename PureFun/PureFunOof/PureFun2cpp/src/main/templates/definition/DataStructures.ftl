...
<#list ast.getVariableList() as variable>
    <#assign constructorParam="${constructorParam}${sym.getType(variable)} ${variable.Name}">
...
<#list ast.getVariableList() as variable>
    ${sym.getType(variable)} const & get_${variable.Name}() const noexcept { return ${variable.Name}; }
</#list>
